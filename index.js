...
let biodata = [
  { id: 1, nama: "Ardhiansyah" },
  { id: 2, umur: "16 tahun" },
  { id: 3, Alamat: "Jl. Bawang 5" },
  { id: 4, instagram: "@withardhiii" },
  { id: 5, nomor_telepon: "081221833028" },
];
...
app.put("/biodata/:id", (request, response) => {
  const identity = biodata.find((data) => data.id === parseInt(request.params.id));
  if (identity) {
